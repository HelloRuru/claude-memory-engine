...
你改了它寫的東西，它才知道「喔，這裡不對」。這種錯不會自動被記住——除非有人幫它建一本錯題本。

**分析**（`/分析`）— 考卷發回來了

你改完它的稿，它逐句比對兩版差異，對照既有規則找根據。已經有的原則沒做到——記錯題，標次數。規則裡沒有的——歸納成新原則，補進去。

**訂正**（任務前自動觸發）— 翻一下上次錯的

動手之前先掃一遍。不是重新學，就是提醒自己：「這個上次錯過，別再犯。」

**反思**（`/反思` 步驟 6）— 段考前總複習

定期掃整本訂正。同一個錯 3 次以上，升級成硬規則。已經學會的，標記清除，不佔位置。但你清楚，從今往後你的 AI 又成長了一些。
